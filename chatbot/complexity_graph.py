...
CHAT_MODEL_PATH = DIR_PATH + "complexity.h5"
...
# aqui começa a mensura do tempo
start = time.time()
# aqui treina-se o modelo com 200 épocas e após isso ele é salvo no formato .h5
model.fit(trainX, trainY, epochs=400, batch_size=5, verbose=1)
model.save(CHAT_MODEL_PATH)
print('Done')
# aqui termina a mensura do tempo
end = time.time()
print(f"Elapsed time: {end - start:.5f}s")

# com 400 epocas e batch_size fixo de 5 = 3.05668s
# com 200 epocas e batch_size fixo de 5 = 1.70986s
# com 100 epocas e batch_size fixo de 5 = 1.00894s
# com 50 epocas e batch_size fixo de 5 = 0.68219s
